...
import com.iset.produits.dao.ProduitsRepository;
...
class ProduitsApplicationTests {
    ...
    public void testfindByNomPrix() {
        List<Produit> prods = produitRepository.findByNomPrix("takoua", 1.00);
        for (Produit p : prods) {
            System.out.println("testFindByNomPrix : " + p.getNomProduit());
        }
    }
    @Test
